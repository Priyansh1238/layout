function About() {
  return (
    <div>
      <h1 style={{ textAlign: "center", fontSize: "40px", fontFamily: "-moz-initial" }}>About:</h1>
      ...
      <div style={{ display: "flex", flexDirection: "row" ,gap:"80px"}}>
                <div>
                    <p style={{ width: "45%", marginTop: "-33%", fontSize: "20px", marginLeft: "69%" }}><b style={{ fontSize: "120px" }}>E</b><p style={{ marginLeft: "70px", marginTop: "-120px", width: "350px" }}>ligendi quam at quis. Sit vel neque</p>
                ...
                <div>
                    <p style={{ width: "45%", fontSize: "20px", marginLeft: "18%",marginTop:"-19%" }}>
